...
output = SOCIAL::SPECIAL.cohort(path_input, n_iterations, distance, platform, puck_size)
...
output = SOCIAL::SPECIAL.cohort(path_special, path_input, n_iterations, distance, platform)
